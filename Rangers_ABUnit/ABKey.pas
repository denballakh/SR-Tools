...
begin
    ...
    for i:=0 to KeyGroup_Count-1 do begin
...
begin
    ...
    if Key_Copy=self then Key_Copy:=nil;
...
var
    ...
    i:integer;
begin
	if KeyGroup_List=nil then begin
	    KeyGroup_List:=TList.Create;
    end else begin
	    for i:=0 to KeyGroup_List.Count-1 do begin
...
var
	k:TKeyAB;
begin
	if (no<0) or (no>KeyGroup_Count) then begin Result:=nil; Exit; end;
...
var
	k:TKeyAB;
begin
	if (no<0) or (no>=KeyGroup_Count) or (KeyGroup_Count<=1) then Exit;
    ...
    if KeyGroup_Cur>=KeyGroup_Count then KeyGroup_Cur:=KeyGroup_Count-1;
end;
...
begin
    ...
    for i:=0 to cnt-1 do begin
        ...
        if i=0 then el:=KeyGroup_List.Items[0]
        else el:=KeyGroup_Insert(KeyGroup_Count);
