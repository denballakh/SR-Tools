...
//	    FGraph.SetTexture(FTexture);
    ...
    FGraph.FDrawFromObjLoop:=ab_InTop(FV[0].FVer.FPosShow.z) and ab_InTop(FV[1].FVer.FPosShow.z) and ab_InTop(FV[2].FVer.FPosShow.z);

    if not FGraph.FDrawFromObjLoop then Exit;
