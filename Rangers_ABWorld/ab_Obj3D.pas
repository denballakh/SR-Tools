...
begin
    ...
    if (FPosOld.x=pos.x) and (FPosOld.y=pos.y) and (FPosOld.z=pos.z) then Exit; 
    VerOpen;
...
//	GR_lpDev.SetRenderState(D3DRS_ALPHABLENDENABLE, DWORD(FALSE));
        	...
        	if ab_Obj3D_Texture then begin
...
begin
    ...
    while el<>nil do begin
    	if (el.FDrawFromObjLoop) and (el.FLoopDraw=ln) then el.Draw;
    	el:=el.FNext;
    end;
end;
