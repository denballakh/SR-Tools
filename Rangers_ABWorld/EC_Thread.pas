...
begin
    ...
    if FTerminateEvent=0 then raise Exception.Create('TThreadEC.Create CreateEvent');
end;
...
begin
    ...
    if FTerminateEvent<>0 then begin CloseHandle(FTerminateEvent); FTerminateEvent:=0; end;
    inherited Destroy;
end;
